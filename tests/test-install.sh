...
assert "Skills copied (6)" "$([ -f "$SKILLS_DIR/craft/SKILL.md" ] && [ -f "$SKILLS_DIR/spec/SKILL.md" ] && echo true || echo false)"
...
assert "6 skills installed" "$([ "$SKILL_COUNT" -eq 6 ] && echo true || echo false)"
